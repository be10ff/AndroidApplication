...
public class GIGPSLocationListener implements LocationListener 
{
	...
	{
		m_map = map;
		locationManager = (LocationManager) m_map.getContext().getSystemService(Context.LOCATION_SERVICE);
...
//		if (null == locationManager.getProvider(mocLocationProvider))
//		{
...
//		new MockLocationProvider(locationManager, mocLocationProvider, track).start();
		/**/
	}



	public GIGPSLocationListener(){
		locationManager = (LocationManager) App.getInstance().getSystemService(Context.LOCATION_SERVICE);
	}

	public GIGPSLocationListener(LocationManager locationManager)
	{
