...
public class GILonLatInputDialog extends DialogFragment 
{
	...
	public static GILonLatInputDialog newInstance(GIGeometryPointControl control){

		Bundle args = new Bundle();
//		args.putInt(LeagueActivity.LEAGUE_ID, leagueId);
//		args.putBoolean(LeagueActivity.IS_USER_TEAM, isUserTeam);
//		args.putInt(LeagueActivity.OPENED_TAB, openedTab);

		GILonLatInputDialog dialog = new GILonLatInputDialog();
