...
import ru.tcgeo.application.layer.renderer.GISQLRenderer;
...
public class GISQLLayer extends GILayer {
	...
	@Override
	public Observable<Tile> getRedrawTiles(GIBounds area, Rect rect, float scaleFactor) {
		return m_renderer.getTiles(this, area, rect, scaleFactor);
	}
