...
import ru.tcgeo.application.views.control.GIControlFloating;
import ru.tcgeo.application.views.control.GIGeometryPointControl;
import ru.tcgeo.application.views.control.GIPositionControl;
import ru.tcgeo.application.views.control.GIScaleControl;
import ru.tcgeo.application.views.control.GITouchControl;
